...
{
	static ConstructorHelpers::FObjectFinder<UAnimMontage>BearAttack_Montage(TEXT("AnimMontage'/Game/Blueprints/Monster/StageThree/Bear/Animations/BearAttackMontage.BearAttackMontage'"));
