...
ABear::ABear()
{
	...
	// 애님블루프린트 찾아 메쉬에 세팅
	static ConstructorHelpers::FObjectFinder<UClass>ABP_Bear(TEXT("AnimBlueprint'/Game/Blueprints/Monster/StageThree/Bear/Blueprints/ABP_CompleteBear.ABP_CompleteBear_C'"));
