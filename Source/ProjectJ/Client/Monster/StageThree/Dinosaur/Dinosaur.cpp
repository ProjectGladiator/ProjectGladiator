...
ADinosaur::ADinosaur()
{
	...
	// 애님블루프린트 찾아 메쉬에 세팅
	static ConstructorHelpers::FObjectFinder<UClass>ABP_Dinosaur(TEXT("AnimBlueprint'/Game/Blueprints/Monster/StageThree/Dinosaur/Blueprints/ABP_Dinosaur.ABP_Dinosaur_C'"));
